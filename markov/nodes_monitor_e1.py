...
class Node01(BasicNode):
    ...
    def __init__(self, OV):
        ...
        self.destStates = [Node01, Node32, Node24]
...
class Node04(BasicNode):
    ...
    def __init__(self, OV):
        ...
        self.probValUTF = [pVar  , pVar   , 0.09   , 0.019  , 0.019  , 0.001  , 0.001  ,  dVar ]
        self.probValLET = [pVar  , pVar   , 0.09   , 0.019  , 0.019  , 0.027  , 0.027  ,  dVar ]
        self.probValAT =  [pVar  , pVar   , 0.07   , 0.019  , 0.019  , 0.027  , 0.027  ,  dVar ]
...
class Node05(BasicNode):
    ...
    def __init__(self, OV):
        ...
        self.probValUTF = [pVar  , pVar  , 0.001 , 0.001 , dVar]
        self.probValATF = [pVar  , pVar  , 0.0062, 0.0062, dVar]
